...
import type { AdminDashboard, AdminRecruiter, AdminRecruiterDetail, AdminStudentDetail, AdminStudentListItem, AuditItem, PaginatedResponse, RpvValidation, RpvValidationDetail } from "@/types/admin";
